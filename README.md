...
## ➡️➡️ <img width="32" height="32" alt="image" src="https://github.com/user-attachments/assets/c178e3e6-6247-4c67-a1b3-db6a7e64ce1e" /> [Check a 45 sec video of the developed app in action!](https://www.linkedin.com/posts/activity-7345491604654190592-DmbJ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAqNIeEBz2Gs3zVOaQx7uL5NGKp_0LzB9OY).

## 📘 Overview

Wordle Rush is a project inspired by the popular web-based word game Wordle, originally created by Josh Wardle.
The goal of this exercise was to study the logic and mechanics behind the game and build a series of programs that can analyze, assist, and even play Wordle automatically.
...
The objective is to find the hidden word in as few tries as possible.
All players share the same daily word, promoting comparison and discussion on social media.

For reference, the official version is available at:
...
Wordle Rush Project – inspired by Josh Wardle’s original Wordle.
Developed as an analytical and algorithmic exercise.
